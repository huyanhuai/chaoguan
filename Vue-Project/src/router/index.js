...
import comment from '@/components/system/order/comment'
import productAndHotel from '@/components/system/config/productAndHotel'  //景+酒
// 酒店
...
import notification from '@/components/system/activity/notification'
import noteQRcode from '@/components/system/activity/noteQRcode'

import dataStatistics from '@/components/system/agentUser/dataStatistics'
import cropper from '@/components/system/product/cropper'
import agentOrder from '@/components/system/order/agentOrder'
Vue.use(Router);
    ...
    children: [
      {
        ...
        path: 'noteQRcode/',
        component: noteQRcode
      },{
        path: 'productAndHotel/',
        component: productAndHotel
      }
    ]
  }]
})
