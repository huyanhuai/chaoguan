    ...
    <div class="Push">
        ...
        <div class="notification">
            <Form label-position="left" :label-width="80">
                <FormItem label="产品名称" >
                    <Input style="width:85%" v-model="productName"></Input>
                </FormItem>
                <FormItem label="手机号" >
    ...
    export default {
        ...
        methods: {
            ...
            subPush() {
                ...
                if(this.mobile == "" && this.productName == ""){
                    this.$Message.error("手机号和产品名称不能为空");
                    return false
                }
                ...
                this.axios
                .post(`${this.AjaxUrl}/ty_manage/activity/sendProxyStorePhoneMessage`,
