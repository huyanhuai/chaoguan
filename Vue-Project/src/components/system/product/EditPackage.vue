  ...
  <div  class="Menu" v-show="ShowCode2">
      ...
      <div class="SetMeal">
        <div>
          ...
          <div class="InputList"  v-if="Package.isFlashSale=='1'">
              <div class="StopTime">
...
<script>
import { getDate, hhssmm, accAdd, accSub,shm,dataTime } from "../../../js/public.js";
  ...
  methods: {
    ...
    getPackageInfo() {
      ...
      this.axios.get(`${this.AjaxUrl}/ty_manage/product/package/getList`, {
        params: {
          productId: this.packageId.productId
        }
      }).then(res => {
        console.log(res);
        this.PackageList = res.data.list;
        this.$emit("refreshList", this.PackageList);
      }).catch(err => {
        console.log(err);
      });
    },
