...
export default {
  ...
  data() {
    return {
      loading: false,
      spinShowImg: false,
      posterImg: require("../../../assets/a11.png"),
      ...
      this.fruit = [];
       this.axios
        ...
        .catch(err => {});
          ...
          this.Imgurl3 = [];
          this.axios
            .get(`${this.AjaxUrl}/ty_manage/hotel/getDetail`, {
              params: {
                hotelId: this.hotelList.hotelId
              }
            })
          ...
          if(coverImg != "" && coverImg != null) {
            ...
            this.posterImg = require("../../../assets/a11.png");
          }
  ...
  methods: {
    ...
    handleRemove1(index,type) {
      ...
      this.axios
        .post(
          `${this.AjaxUrl}/ty_manage/hotel/picture/delete`,
          this.qs.stringify(data)
        )
        .then(res => {
          if (res.errorCode == 200) {
