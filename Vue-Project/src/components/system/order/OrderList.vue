...
<script>
  import {formatDate,getDate} from "../../../js/public";
  export default {
    data() {
      return {
        loading: true,
        ...
        TableTop: [
          ...
          },
          {
            ...
            render: (h, params) => {
              return h("div", [
                h("strong", getDate(params.row.arriveTime))
              ]);
            }
          },
          {
            ...
            align: "center",
            render: (h, params) => {
              let text = params.row.companyName;
              if(params.row.companyName == null || params.row.companyName ==""){
                text = params.row.legalRepresentativeName;
              } 
              console.log(params.row.legalRepresentativeName)
              return h("div", [
                h("span", text)
              ]);
            }
